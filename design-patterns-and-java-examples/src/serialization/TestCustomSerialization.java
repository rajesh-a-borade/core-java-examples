...
public class TestCustomSerialization
{
    public static void main(String[] args)
    {
        ...
        User myDetails = new User("L", "R", 102825, new Date(Calendar.getInstance().getTimeInMillis()));
 
        // Serialization code
        try
        {
            FileOutputStream fileOut = new FileOutputStream("C:\\temp\\User.ser");
        ...
        try
        {
            FileInputStream fileIn = new FileInputStream("C:\\temp\\User.ser");
